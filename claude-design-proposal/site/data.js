...
window.BINAH_MODULES = [
  {
    ...
    description: "WhatsApp, Instagram y correo convergen en un inbox único. Tus agentes de IA — ventas, soporte y reservas — responden, califican y cierran 24/7.",
    features: [
  ...
  },
  {
    ...
    description: "Despacha, rastrea y vincula pedidos con clientes en segundos. Visibilidad total de inventario, transportadoras y entregas.",
    features: [
  ...
  },
  {
    ...
    description: "Cumplimiento total con la regulación colombiana. Genera, firma y envía cada documento electrónico requerido automáticamente.",
    features: [
  ...
  },
  {
    ...
    description: "Seguimiento de costos, órdenes de compra, proveedores y conciliaciones — todo conectado con ventas y facturación.",
    features: [
      "Órdenes de compra",
  ...
  },
  {
    ...
    description: "Canales, mensajes directos e hilos dentro de la misma plataforma donde tu equipo ya trabaja.",
    features: [
  ...
  },
  {
    ...
    description: "Centraliza agenda, asignación de personal, seguimiento de servicios y soporte postventa en un único panel.",
    features: [
  ...
  },
  {
    ...
    description: "Tableros, listas y cronogramas para que los equipos avancen sin saltar entre cinco apps.",
    features: [
      "Tableros Kanban",
  ...
  },
  {
    ...
    description: "Links de pago, cobros recurrentes y conciliación automática con tu facturación electrónica.",
    features: [
  ...
  },
  {
    ...
    description: "Dashboards que combinan ventas, operaciones, finanzas y soporte — porque todo vive en la misma base de datos.",
    features: [
